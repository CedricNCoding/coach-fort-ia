-- Use unqualified pgp_sym_encrypt/pgp_sym_decrypt assuming pgcrypto installed in public
...
BEGIN
  ...
  SELECT 
    CASE 
      ...
      THEN pgp_sym_decrypt(decode(ai_settings.api_key, 'base64'), public.get_encryption_key())
      ELSE NULL 
    END,
