-- Fix user_id type mismatch (text vs uuid)
...
BEGIN
  ...
  WHERE ai_settings.user_id = _user_id::text;
END;
$$;

-- Ensure set_user_api_key stores text user_id explicitly
...
BEGIN
  INSERT INTO public.ai_settings (
    ...
    _user_id::text,
    CASE WHEN _api_key IS NOT NULL AND _api_key <> ''
